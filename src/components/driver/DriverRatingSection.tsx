...
export default function DriverRatingSection({ orderId, initialRating }: DriverRatingSectionProps) {
    const [rating, setRating] = useState<Rating | null | undefined>(initialRating);
    ...
    return (
        <Stack spacing={1.5}>
            ...
            {showReplyForm ? (
                ...
                <Button size="small" variant="outlined" onClick={handleOpenReply} sx={{ alignSelf: 'flex-start' }}>
                    Reply to review
                </Button>
            ) : null}
